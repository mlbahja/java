public class ExerciseRunner{
    public static void main(String[] args){
        System.out.println(IntOperations.addTwoIntegers(5,6));
        System.out.println(IntOperations.subtractTwoIntegers(8,9));
        System.out.println(IntOperations.multiplyTwoIntegers(9,3));
        System.out.println(IntOperations.divideTwoIntegers(4,4));    
        System.out.println("-----------------------");
